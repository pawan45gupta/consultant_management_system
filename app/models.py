...
class Consultant(models.Model):
    ...
    justificaiton_for_remaining_onboarded = models.TextField(
        "Justification for Consultant to Remain Onboarded (Specify Deliverables/Scope)", max_length=1000, blank=True,
        null=True)
    ...
    def __str__(self):
        return self.eda_vendor + " - " + self.consultant_name + " - " + str(self.consultant_start_date) + " - " + str(
